...
* Ascertain how many training epochs are needed to train a fully connected TensFlow neural net. This will be used in future training.
...
* A training period of 30 epcohs (minibatch size 32) will be used in furture experiments using this model structure.